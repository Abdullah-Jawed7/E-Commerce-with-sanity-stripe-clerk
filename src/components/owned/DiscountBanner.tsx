                        ...
                        <CardContent className='p-0'>
                            <div className='flex flex-col md:flex-row items-center'>
                                <div className='flex-1 p-6 md:px-12'>
                                  ...
                                  <h2 className='mb-2 md:mb-4 text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight
                                 '>{sale?.title}</h2>
                                  <p className='mb-2 md:mb-4 text-muted-foreground'>{sale?.description}</p>
                                  <p className='mb-2 '>
                                    Use Code:{" "} <span className='font-semibold text-primary uppercase'>
                                        {sale?.couponCode}
                                    </span>{" "}
                                    for{" "}
                                    <span className='font-semibold'>
                                        {sale?.discountAmount}%</span>{" "}OFF
                                  </p>
                                ...
                                {sale?.image && (
                                    <div className='w-full md:w-1/2 h-auto flex items-center justify-center py-2'>
                                        ...
                                        alt='banner Image'
                                         width={500} 
                                         height={500}
                                         className='object-cover h-full  transition-transform hover:scale-105 
